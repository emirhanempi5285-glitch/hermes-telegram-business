...
- Deletions keep earlier text intact; they append tombstones plus a later classification event.
...
- Optional controls:
  - `HERMES_TELEGRAM_BUSINESS_HISTORY_CORRECTION_WINDOW` seconds, default `120`
